...
${OBJECTDIR}/string_hash.o: string_hash.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../../externals/xxHash -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/string_hash.o string_hash.cpp
...
${OBJECTDIR}/string_page_archive.o: string_page_archive.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../../externals/xxHash -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/string_page_archive.o string_page_archive.cpp

${OBJECTDIR}/string_page_catalog.o: string_page_catalog.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../../externals/xxHash -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/string_page_catalog.o string_page_catalog.cpp

${OBJECTDIR}/string_page_nursery.o: string_page_nursery.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../../externals/xxHash -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/string_page_nursery.o string_page_nursery.cpp

${OBJECTDIR}/string_page_ptr.o: string_page_ptr.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../../externals/xxHash -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/string_page_ptr.o string_page_ptr.cpp

${OBJECTDIR}/string_page_sizes.o: string_page_sizes.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../../externals/xxHash -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/string_page_sizes.o string_page_sizes.cpp
...
${TESTDIR}/TestFiles/f2: ${TESTDIR}/tests/string_hash_tests.o ${OBJECTFILES:%.o=%_nomain.o}
	...
	${LINK.cc}   -o ${TESTDIR}/TestFiles/f2 $^ ${LDLIBSOPTIONS} ../../externals/installed/lib/libgtest.a ../../externals/installed/lib/libgtest_main.a -lpthread $(LDLIBS) 

${TESTDIR}/TestFiles/f10: ${TESTDIR}/tests/string_intern_tests.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc}   -o ${TESTDIR}/TestFiles/f10 $^ ${LDLIBSOPTIONS} ../../externals/installed/lib/libgtest.a ../../externals/installed/lib/libgtest_main.a -lpthread $(LDLIBS) 

${TESTDIR}/TestFiles/f1: ${TESTDIR}/tests/string_page_tests.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc}   -o ${TESTDIR}/TestFiles/f1 $^ ${LDLIBSOPTIONS} ../../externals/installed/lib/libgtest.a ../../externals/installed/lib/libgtest_main.a -lpthread $(LDLIBS) 

${TESTDIR}/TestFiles/f6: ${TESTDIR}/tests/string_page_archive_tests.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc}   -o ${TESTDIR}/TestFiles/f6 $^ ${LDLIBSOPTIONS} ../../externals/installed/lib/libgtest.a ../../externals/installed/lib/libgtest_main.a -lpthread $(LDLIBS) 

${TESTDIR}/TestFiles/f5: ${TESTDIR}/tests/string_page_catalog_tests.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc}   -o ${TESTDIR}/TestFiles/f5 $^ ${LDLIBSOPTIONS} ../../externals/installed/lib/libgtest.a ../../externals/installed/lib/libgtest_main.a -lpthread $(LDLIBS) 

${TESTDIR}/TestFiles/f9: ${TESTDIR}/tests/string_page_nursery_tests.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc}   -o ${TESTDIR}/TestFiles/f9 $^ ${LDLIBSOPTIONS} ../../externals/installed/lib/libgtest.a ../../externals/installed/lib/libgtest_main.a -lpthread $(LDLIBS) 

${TESTDIR}/TestFiles/f7: ${TESTDIR}/tests/string_page_ptr_tests.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc}   -o ${TESTDIR}/TestFiles/f7 $^ ${LDLIBSOPTIONS} ../../externals/installed/lib/libgtest.a ../../externals/installed/lib/libgtest_main.a -lpthread $(LDLIBS) 

${TESTDIR}/TestFiles/f8: ${TESTDIR}/tests/string_pages_tests.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc}   -o ${TESTDIR}/TestFiles/f8 $^ ${LDLIBSOPTIONS} ../../externals/installed/lib/libgtest.a ../../externals/installed/lib/libgtest_main.a -lpthread $(LDLIBS) 

${TESTDIR}/TestFiles/f3: ${TESTDIR}/tests/string_page_sizes_tests.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc}   -o ${TESTDIR}/TestFiles/f3 $^ ${LDLIBSOPTIONS} ../../externals/installed/lib/libgtest.a ../../externals/installed/lib/libgtest_main.a -lpthread $(LDLIBS) 

${TESTDIR}/TestFiles/f4: ${TESTDIR}/tests/string_reference_tests.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc}   -o ${TESTDIR}/TestFiles/f4 $^ ${LDLIBSOPTIONS} ../../externals/installed/lib/libgtest.a ../../externals/installed/lib/libgtest_main.a -lpthread $(LDLIBS) 


${TESTDIR}/tests/string_hash_tests.o: tests/string_hash_tests.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../../externals/xxHash -I../../externals/installed/include -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/string_hash_tests.o tests/string_hash_tests.cpp


${TESTDIR}/tests/string_intern_tests.o: tests/string_intern_tests.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../../externals/xxHash -I../../externals/installed/include -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/string_intern_tests.o tests/string_intern_tests.cpp


${TESTDIR}/tests/string_page_tests.o: tests/string_page_tests.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../../externals/xxHash -I../../externals/installed/include -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/string_page_tests.o tests/string_page_tests.cpp


${TESTDIR}/tests/string_page_archive_tests.o: tests/string_page_archive_tests.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../../externals/xxHash -I../../externals/installed/include -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/string_page_archive_tests.o tests/string_page_archive_tests.cpp
...
${TESTDIR}/tests/string_page_ptr_tests.o: tests/string_page_ptr_tests.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../../externals/xxHash -I../../externals/installed/include -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/string_page_ptr_tests.o tests/string_page_ptr_tests.cpp


${TESTDIR}/tests/string_pages_tests.o: tests/string_pages_tests.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../../externals/xxHash -I../../externals/installed/include -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/string_pages_tests.o tests/string_pages_tests.cpp


${TESTDIR}/tests/string_page_sizes_tests.o: tests/string_page_sizes_tests.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../../externals/xxHash -I../../externals/installed/include -I. -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/string_page_sizes_tests.o tests/string_page_sizes_tests.cpp


${TESTDIR}/tests/string_reference_tests.o: tests/string_reference_tests.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../../externals/xxHash -I../../externals/installed/include -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/string_reference_tests.o tests/string_reference_tests.cpp
...
${OBJECTDIR}/_ext/1406610357/xxhash_nomain.o: ${OBJECTDIR}/_ext/1406610357/xxhash.o ../../externals/xxHash/xxhash.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1406610357/xxhash_nomain.o ../../externals/xxHash/xxhash.c;\
	else  \
...
${OBJECTDIR}/string_hash_nomain.o: ${OBJECTDIR}/string_hash.o string_hash.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -I../../externals/xxHash -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/string_hash_nomain.o string_hash.cpp;\
	else  \
...
${OBJECTDIR}/string_intern_nomain.o: ${OBJECTDIR}/string_intern.o string_intern.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -I../../externals/xxHash -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/string_intern_nomain.o string_intern.cpp;\
	else  \
...
${OBJECTDIR}/string_page_nomain.o: ${OBJECTDIR}/string_page.o string_page.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -I../../externals/xxHash -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/string_page_nomain.o string_page.cpp;\
	else  \
...
${OBJECTDIR}/string_page_archive_nomain.o: ${OBJECTDIR}/string_page_archive.o string_page_archive.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -I../../externals/xxHash -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/string_page_archive_nomain.o string_page_archive.cpp;\
	else  \
...
${OBJECTDIR}/string_page_catalog_nomain.o: ${OBJECTDIR}/string_page_catalog.o string_page_catalog.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -I../../externals/xxHash -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/string_page_catalog_nomain.o string_page_catalog.cpp;\
	else  \
...
${OBJECTDIR}/string_page_nursery_nomain.o: ${OBJECTDIR}/string_page_nursery.o string_page_nursery.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -I../../externals/xxHash -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/string_page_nursery_nomain.o string_page_nursery.cpp;\
	else  \
...
${OBJECTDIR}/string_page_ptr_nomain.o: ${OBJECTDIR}/string_page_ptr.o string_page_ptr.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -I../../externals/xxHash -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/string_page_ptr_nomain.o string_page_ptr.cpp;\
	else  \
...
${OBJECTDIR}/string_page_sizes_nomain.o: ${OBJECTDIR}/string_page_sizes.o string_page_sizes.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -I../../externals/xxHash -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/string_page_sizes_nomain.o string_page_sizes.cpp;\
	else  \
...
${OBJECTDIR}/string_pages_nomain.o: ${OBJECTDIR}/string_pages.o string_pages.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -I../../externals/xxHash -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/string_pages_nomain.o string_pages.cpp;\
	else  \
...
${OBJECTDIR}/string_reference_nomain.o: ${OBJECTDIR}/string_reference.o string_reference.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -I../../externals/xxHash -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/string_reference_nomain.o string_reference.cpp;\
	else  \
