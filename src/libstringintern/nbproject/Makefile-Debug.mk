...
${TESTDIR}/tests/string_intern_tests.o: tests/string_intern_tests.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../externals/xxHash -I../../externals/installed/include -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/string_intern_tests.o tests/string_intern_tests.cpp
...
${TESTDIR}/tests/string_page_nursery_tests.o: tests/string_page_nursery_tests.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../externals/xxHash -I../../externals/installed/include -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/string_page_nursery_tests.o tests/string_page_nursery_tests.cpp
